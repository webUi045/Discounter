      ...
      {loading ? <img className="loader" src={loader} alt="loader"/> : <>
        ...
        <div className="form-section">
          <Input
            ...
            style={emailError ? "profile__input profile-input-error" : "profile__input"}
            disabled
        ...
        <div className="form-section">
          <Input
            ...
            style={passwordError ? "profile__input profile-input-error" : "profile__input"}
            disabled
